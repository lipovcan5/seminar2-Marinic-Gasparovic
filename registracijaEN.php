	...
	<section class="container row">
		...
		<section class="prijava2">
			...
			<form action="signUpEN.php" method="POST">
			    <input type="text" name="ime" placeholder="Name *" style="width:200px; height:30px; margin-left:200px; margin-top:30px;">
			    <input type="text" name="prezime" placeholder="Surname *" style="width:200px; height:30px; margin-left:200px; margin-top:30px;">
				<input type="text" name="usr" placeholder="username *" style="width:200px; height:30px; margin-left:200px; margin-top:30px;">
				<input type="password" name="pwd" placeholder="password *" style="width:200px; height:30px; margin-left:200px; margin-top:30px;">
				<input type="password" name="pwd2" placeholder=" repeat password *" style="width:200px; height:30px; margin-left:200px; margin-top:30px;">
				<input type="text" name="mail" placeholder=" e-mail *" style="width:200px; height:30px; margin-left:200px; margin-top:30px;">	
				<input type="submit" value="Sign Up" style="width:200px; height:30px; margin-left:200px; margin-top:30px; background:rgb(240,84,18);">
