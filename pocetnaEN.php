...
<section class="objedini row">
	...
	<form action="pocetnaEN.php" method="POST">
		<div class="lijevo2 ">
...
?>
	...
	<div class="desno2 ">
		...
		if (isset($_POST['nazivMjesto'])) {
			...
			$slika1=$row['slika1'];
			$id=$row['idKorisnik'];
			echo "<form action='odabirEN.php' method='POST'>";
			echo "<div class='cijeliDiv'>";
			  ...
			  echo "<div class='tekstic' style='width:60%; margin-left:20px; position:relative; float:left;'><h2>".$row['naslovEN']."</h2></div>";
			  echo "<div class='tekstic' style='width:60%; margin-left:20px; position:relative; float:left;'><p>".$row['kratkiOpisEN']."</p></div>";
			  echo "<div class='tekstic' style='width:60%; margin-left:20px; position:relative; float:left;'><p>".'Price:'.$row['cijena'].$row['imeValute']."</p></div>";
			echo "</div>";
			echo "</form>";
			  echo "<br>";
			  echo "<br>";
